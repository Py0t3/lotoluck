 <!--	
	Pagina que nos permite mostrar todos los sorteos de LAE - Loteria Navidad guardados en la BBDD
-->
...
<!DOCTYPE html>
	...
	?>
		...
		<div class='titulo' style='margin-bottom:1em;'>
				...
				<table> 
					<tr>
						<td class='titulo'> Loteria Navidad - Resultados </td>
						<td width="30%"> </td>
						<td> 
							<a href='loteriaNavidad_dades.php?idSorteo=-1'><button class='cms' style='width:175px; margin-left:100%; color:black;'>Nuevo sorteo</button></a>
					</td>
				</tr>
			</table>
		</div>
