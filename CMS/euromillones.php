			...
			<div class='titulo' style='margin-bottom:1em;'>	
					<table> 
						<tr>
							...
							<td width="30%"> </td>
							<td><a href='euromillones_dades.php?idSorteo=-1'> <button class='cms' style='width:175px; margin-left:100;color:black;'>Nuevo sorteo</button></a> </td>
						</tr>
					</table>
					<script>
					function nuevo(){
						window.location.href="euromillones_dades.php?idSorteo=-1";
					}
					</script>
			</div>
			<div>
				...
				<thead>	
					<tr>
						...
						<td class="cabecera"> Números </td>
						<td class="cabecera"> Estrellas </td>
						<td class="cabecera"> Editar </td>
						<td class="cabecera"> Eliminar </td>
					</tr>
				</thead>
					<?php 
						MostrarSorteosEuromillones();
					?>
