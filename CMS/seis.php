		...
		<div class='titulo'style='margin-bottom:1em;'>
				...
				<table> 
					<tr>
						...
						<td width="30%"> </td>
						<td><a href='seis_dades.php?idSorteo=-1'> <button class='cms' style='width:175px; margin-left:100%;color:black;'>Nuevo sorteo</button></a> </td>
					</tr>
				</table>
		</div>
		...
		<div>
			...
			<thead>
				<tr>
					...
					<td class="cabecera"> Plus </td>
					<td class="cabecera"> C </td>
					<td class="cabecera"> R </td>
					<td class="cabecera"> Joquer </td>
