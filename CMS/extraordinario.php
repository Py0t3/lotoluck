		...
		<div class='titulo'style='margin-bottom:1em;'>
			<table>
				<tr>
					...
					<td width="30%"> </td>
					<td>
					<button class='cms' style='width:175px; margin-left:100%' onclick='nuevo()'>Nuevo sorteo</button>
					</td>
				</tr>
			</table>
			<script>
			function nuevo(){
				window.location.href='extraordinario_dades.php?idSorteo=-1';
			}
			</script>
		</div>
		<div>
