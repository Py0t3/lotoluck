<!-- 
	Pagina que nos permite mostrar todos los sorteos de LC - La Grossa guardados en la BBDD
-->
...
<html>
	...
	?>
		...
		<div class='titulo' style='margin-bottom:1em;'>
			...
			<table>
				<tr>
					...
					<td width="30%"> </td>
					<td><a href='grossa_dades.php?idSorteo=-1' ><button class='cms' style="width:175px; margin-left:70%">Nuevo sorteo</button></a></td>
				</tr>
			</table>
		</div>
		...
		<div>
			...
			<thead>	
				<tr>
					...
					<td class="cabecera"> Número ganador </td>
					<td class="cabecera" > Reintegro 1 </td>
					<td class="cabecera" > Reintegro 2 </td>
		...
		<script type="text/javascript">
			...
			{
				// Función que permite eliminar el sorteo que se pasa como parametro
				if (confirm("¿Quieres eliminar el sorteo? Pulsa OK para eliminar.") == true)
				{
					var datos = [4, idSorteo, -1, -1, -1, -1, -1, -1, -1, -1];
