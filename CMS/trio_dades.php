							...
							if (posicion != '')
							{
								...
								$("#principal tbody tr").each(function(i) {
									...
									if (posicion > $("#principal tbody tr").length) {
										...
										'<td><input class="resultados acertantes" name="acertantes" type="text" style="width:100px;" value="0" onchange="Reset()"></td>'+
										'<td><input class="resultados euros" name="euros" type="text" style="width:200px;" value="0" onchange="Reset()"></td>'+
